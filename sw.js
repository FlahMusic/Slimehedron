const C='slimehedron-v9'; // bump each deploy
const FILES=['./','./index.html','./learn.js','./landing.html','./manifest.json','./icon-192.png','./icon-512.png','./slimehedron-mascot.png','./bg.jpg','./slimelogo.png'];
